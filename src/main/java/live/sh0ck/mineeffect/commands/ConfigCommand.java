...
import live.sh0ck.mineeffect.MineEffect;
...
public class ConfigCommand extends BaseCommand implements TabCompleter, IPlayerCommand, IServerCommand {
  ...
  private void handleReload(CommandSender sender, String[] args) {
    ...
    try {
      ...
      sender.sendMessage(ChatColor.RED + "If this issue is repeating and you know it shouldn't, make a " + ChatColor.GOLD + "bug report" + ChatColor.RED + " at https://github.com/sh0ckR6/MineEffect/issues/new/choose.");
    }
  }
  ...
  private void handleEdit(CommandSender sender, String[] args) {
    ...
    if (!(oldValue instanceof Integer) && !(oldValue instanceof String) && !(oldValue instanceof Float) && !(oldValue instanceof Boolean)) {
      sender.sendMessage(ChatColor.RED + "The type of value you are trying to edit is not yet supported! If you would like to see support added for this value, "
                         ...
                         + ChatColor.RESET + ChatColor.GOLD + "https://github.com/sh0ckR6/MineEffect/issues/new/choose");
      return;
    }
    ...
    ConfigManager.reloadConfig(config, plugin);
